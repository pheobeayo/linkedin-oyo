  ...
  return (
    <section id="contact" className="relative">
      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-center">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-14 p-14 flex items-center justify-center relative">

          <div className="bg-gray-900 relative flex flex-wrap py-8 rounded shadow-md">
            <div className="lg:w- px-6 mt-4 lg:mt-0">


              <a href="https://www.linkedin.com/company/linkedin-local-oyo/" target="">
                <button
                  type="button"
                  data-te-ripple-init
              ...
              <a href="https://www.instagram.com/linkedinlocaloyo/" target="">
                <button
                  type="button"
                  data-te-ripple-init
                  data-te-ripple-color="light"
              ...
              <a href="https://twitter.com/LinkedinlocalOy" target="">
                <button
                  type="button"
                  data-te-ripple-init
                  data-te-ripple-color="light"
